...
class _HomeViewBodyState extends State<HomeViewBody> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<GeneratePlanCubitCubit, GeneratePlanCubitState>(
                ...
                child: BlocListener<PlanDetailsCubit, PlanDetailsState>(
                  listener: (context, planState) {
                    if (planState is PlanDetailsSuccess) {
                      showSuccessSnackBar(context, 'Plan saved successfully');
                    } else if (planState is PlanDetailsFailure) {
                      showErrorSnackBar(context, planState.errorMessage);
                    }
                  },
                  child: Scaffold(
                    body: ItineraryView(
      ...
      builder: (context, state) {
        final isLoading = state is GeneratePlanCubitLoading;
        return AppModalHud(
          isLoading: isLoading,
                  ...
                  CustomButton(
                    ...
                    onPressed: isLoading
                        ...
                        : () {
                            ...
                            BlocProvider.of<GeneratePlanCubitCubit>(
                              context,
                            ).generatePlan(
                              userToken: userToken,
