...
import 'package:travel_trek/Features/auth/presentation/manger/forgot_password_cubit/forgot_password_cubit.dart';
...
class ForgotPasswordView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => ForgotPasswordCubit(authRepo: getIt<AuthRepo>()),
      child: const Scaffold(
        backgroundColor: Color(0xffFDFDFB),
        body: SafeArea(child: _ForgotPasswordBody()),
      ),
    );
  }
}
